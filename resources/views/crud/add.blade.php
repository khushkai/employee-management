...
<div class="form-container">
    <h2>{{ isset($crud) ? 'Edit Crud' : 'Add Crud' }}</h2>
    ...
    <form action="{{ isset($crud) ? route('crud.update', $crud->id) : route('crud.store') }}" method="POST" novalidate>
        @csrf
        @if(isset($crud))
            @method('PUT')
        @endif
        ...
        <div>
            ...
            <input type="text" name="name" value="{{ old('name', $crud->name ?? '') }}"
        ...
        <div>
            ...
            <input type="age" name="age" value="{{ old('age', $crud->age ?? '') }}"
