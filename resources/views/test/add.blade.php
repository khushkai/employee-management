...
<div class="form-container">
    <h2>{{ isset($test) ? 'Edit Test' : 'Add Test' }}</h2>
    ...
    <form action="{{ isset($test) ? route('test.update', $test->id) : route('test.store') }}" method="POST" novalidate>
        @csrf
        @if(isset($test))
            @method('PUT')
        @endif
        ...
        <div>
            ...
            <input type="age" name="age" value="{{ old('age', $test->age ?? '') }}"
